...
function cm.mfilter(c,e)
	return c:IsHasEffect(37564800) and c:IsCanBeFusionMaterial() and c:IsAbleToRemove() and not c:IsImmuneToEffect(e) and c:IsType(TYPE_MONSTER)
end
...
function cm.cfilter(c)
	return c:IsHasEffect(37564800) and c:IsType(TYPE_MONSTER) and c:IsAbleToDeckOrExtraAsCost()
end
