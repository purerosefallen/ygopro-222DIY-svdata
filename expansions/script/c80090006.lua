...
function c80090006.initial_effect(c)
	...
	e3:SetCountLimit(1)
	e3:SetTarget(c80090006.limtg)
	e3:SetCost(c80090006.atkcost)
	e3:SetOperation(c80090006.atkop)
	c:RegisterEffect(e3)   
end
...
function c80090006.atkop(e,tp,eg,ep,ev,re,r,rp)
	...
	e1:SetValue(c80090006.aclimit)
	e1:SetReset(RESET_PHASE+PHASE_END)
	Duel.RegisterEffect(e1,tp)
end
function c80090006.aclimit(e,re,tp)
	local rc=re:GetHandler()
	return re:IsActiveType(TYPE_SPELL+TYPE_TRAP) and not rc:IsImmuneToEffect(e)
end
function c80090006.limtg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return true end
	Duel.SetChainLimit(c80090006.chainlm)
end
function c80090006.chainlm(e,rp,tp)
	return tp==rp
end