...
function cm.spcon(e,c)
	...
	return Duel.CheckReleaseGroup(c:GetControler(),Card.IsHasEffect,ct,nil,37564800)
end
function cm.spop(e,tp,eg,ep,ev,re,r,rp,c)
	local ft=Duel.GetLocationCount(c:GetControler(),LOCATION_MZONE)
	local ct=math.max(1,-ft)
	local g=Duel.SelectReleaseGroup(c:GetControler(),Card.IsHasEffect,ct,63,nil,37564800)
	c:SetMaterial(g)
