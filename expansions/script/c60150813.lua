...
function c60150813.ctop(e,tp,eg,ep,ev,re,r,rp)
	...
	if ct>0 then
		e:GetHandler():AddCounter(0x10fe,1)
	end
end
function c60150813.atkval(e,c)
	return e:GetHandler():GetCounter(0x10fe)*50
end
...
function c60150813.cost3(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return e:GetHandler():IsCanRemoveCounter(tp,0x10fe,3,REASON_COST)
	...
	e:GetHandler():RemoveCounter(tp,0x10fe,3,REASON_COST)
