...
function c80090030.filter(c)
	return c:IsSetCard(0x82d4) and c:IsType(TYPE_SPELL+TYPE_TRAP) and c:IsAbleToHand() and not c:IsCode(80090030)
end
...
function c80090030.thfilter(c)
	return c:IsSetCard(0x82d4) and c:IsAbleToHand() and not c:IsCode(80090030)
end
