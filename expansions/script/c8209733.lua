...
function c8209733.filter1(c,e,tp)
	local rk=c:GetRank()
	return c:IsFaceup() and c:IsSetCard(0x3220) and c:IsType(TYPE_XYZ)
...
function c8209733.filter2(c,e,tp,mc,rk)
	return c:GetRank()==rk and c:IsSetCard(0x3220) and mc:IsCanBeXyzMaterial(c)
...
function c8209733.thfilter(c)
	return c:IsType(TYPE_XYZ) and c:IsSetCard(0x3220) and c:IsAbleToRemoveAsCost()
end
