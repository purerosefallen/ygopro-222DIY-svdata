...
function cm.condition(e,tp,eg,ep,ev,re,r,rp)
	return eg:IsExists(cm.cfilter,1,nil,1-tp) and senya.nncon(false)(e,tp)
end
...
function cm.filter(c,e,tp)
	return c:IsRelateToEffect(e) and c:IsControler(tp) and c:IsAbleToRemove() and not c:IsImmuneToEffect(e)
end
