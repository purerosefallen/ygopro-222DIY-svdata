...
function c13254040.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(c13254040.cfilter,tp,LOCATION_HAND,0,1,e:GetHandler()) end
	Duel.DiscardHand(tp,c13254040.cfilter,1,1,REASON_COST+REASON_DISCARD)
end
...
function c13254040.disfilter(c)
	return c:IsSetCard(0x1356) and c:IsType(TYPE_MONSTER) and c:IsAbleToHand()
end
