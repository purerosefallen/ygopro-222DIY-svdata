...
function c80090032.filter(c)
	return c:IsType(TYPE_SPELL+TYPE_TRAP) and c:IsSetCard(0x82d4)
end
function c80090032.filter1(c)
	return c:IsType(TYPE_MONSTER) and c:IsSetCard(0x82d4)
end
...
function c80090032.filter2(c)
	return c:IsSetCard(0x82d4) and c:IsAbleToRemove() and c:IsType(TYPE_MONSTER)
end
